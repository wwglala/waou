...
var RenderModal = function (props) {
    ...
    var _a = React.useContext(ModalContext), setVisibleIds = _a.setVisibleIds, loadingField = _a.loadingField;
    var _b = React.useState(modalProps), injectModalProps = _b[0], setModalProps = _b[1];
    ...
    return (React__default["default"].createElement(ModalComponent, __assign({ visible: visibleIds.includes(modalId), onCancel: onReject }, injectModalProps, { onOk: onOk }),
...
var ModalProvider = React.memo(function (props) {
    ...
    var _b = React.useState([]), visibleIds = _b[0], setVisibleIds = _b[1];
    // context link
    var config = React.useContext(ModalContext).config;
...
var createModalHook = function (type) {
    ...
    useModal.useRegister = function (modalId, Component) {
        var _a = React.useContext(ModalContext), init = _a.init, updateAndSaveModal = _a.updateAndSaveModal, destroyById = _a.destroyById;
        if (!init) {
            throw new Error("useModal !\n    please use the ModalProvider to init!\n    like this: <ModalProvider modal={Modal} sideSheet={sideSheet}>{children}</ModalProvider>\n  ");
        }
        React.useMemo(function () {
